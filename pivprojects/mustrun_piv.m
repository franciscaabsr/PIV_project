...
base_data_dir='/home/francisca/Documents/PIV/Matlab/PIV_project/datasets/lab1/';
...
for i=1:size(texto,2),
    ...
    if strcmp(texto{2,i}(1:2),'OK'),
       ...
       for j=1:length(im1),           
           load(im1(j).depth);
           xyz1=get_xyz_asus(depth_array(:),[480 640],(1:640*480)', cam_params.Kdepth,1,0);
           load(im2(j).depth);
           xyz2=get_xyz_asus(depth_array(:),[480 640],(1:640*480)', cam_params.Kdepth,1,0);
           xyz=(R2*xyz2'+repmat(T2,[1,640*480]))';
